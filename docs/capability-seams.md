...
| `ctx.llmFiles` | `seam` | [`llm-files`](../packages/llm/llm-files) | - | - | - | Provider plugins register upload, quota recovery, and deletion operations; model adapters share digest-keyed uploads without persisting provider file identifiers. |
