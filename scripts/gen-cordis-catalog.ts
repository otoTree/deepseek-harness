...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LlmFileMetrics: 'llm-streaming.md',
  LlmFileReference: 'llm-streaming.md',
  LlmFileRequest: 'llm-streaming.md',
  LlmFilesProvider: 'llm-streaming.md',
  ProviderFileId: 'llm-streaming.md',
